  ...
  const agents = [
    {
      ...
      description: "This bot handles both appointment scheduling and lead generation. It answers user questions and guides them through lead generation and appointment scheduling.",
      version: "1.0.0",
    ...
    },
    {
      ...
      description: "An appointment scheduling example that answers questions about Stammer.ai and prompts users to schedule appointments. Requires Google Calendar integration for full functionality.",
      version: "1.0.0",
      developer: "Tim Bramlett",
    ...
    <div className="min-h-screen bg-gray-100">
      <div className="bg-blue-600 text-white py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl">
            Explore and clone AI agents for your needs
          </p>
        </div>
      </div>
